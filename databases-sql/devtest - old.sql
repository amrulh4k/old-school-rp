...
--
-- Host: localhost
-- Generation Time: Apr 04, 2018 at 04:05 PM
...
CREATE TABLE IF NOT EXISTS `actordb` (
  `ID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `factionlockers` (
  `id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gangsold` (
  `id` tinyint(2) DEFAULT NULL,
  `name` varchar(32) DEFAULT 'None',
  `motd` varchar(128) DEFAULT 'None',
  `leader` varchar(24) DEFAULT 'No-one',
...
CREATE TABLE IF NOT EXISTS `log_cp` (
  `id` int(11) NOT NULL,
  `executer` text,
  `description` text,
...
CREATE TABLE IF NOT EXISTS `log_dicebet` (
  `id` int(10) NOT NULL,
  `date` datetime DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `log_givecookie` (
  `id` int(10) NOT NULL,
  `date` datetime DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `log_givegun` (
  `id` int(10) NOT NULL,
  `date` datetime DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `log_givemoney` (
  `id` int(10) NOT NULL,
  `date` datetime DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `log_makehelper` (
  `id` int(10) NOT NULL,
  `date` datetime DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `log_namehistory` (
  `id` int(10) NOT NULL,
  `uid` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `log_setstat` (
  `id` int(10) NOT NULL,
  `date` datetime DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `playerbackpack` (
  `ID` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `posts_acp` (
